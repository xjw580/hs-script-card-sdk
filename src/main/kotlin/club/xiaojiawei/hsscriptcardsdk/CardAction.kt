...
abstract class CardAction(
     ...
     * 例如：[belongCard]为萨满基础技能时，那么此时至多可以返回一个[club.xiaojiawei.hsscriptcardsdk.bean.Action]，即在战场未满的情况下生成图腾至战场这个[club.xiaojiawei.hsscriptcardsdk.bean.Action]
     * 对于战场上的技能，地标使用都是调用此方法生成动作
     * @param war 此卡牌所处的战局，注意：生成的[club.xiaojiawei.hsscriptcardsdk.bean.Action]中应使用[club.xiaojiawei.hsscriptcardsdk.bean.Action]内部传递的war，而不是此处的war
...
//                        模拟发射
     ...
     * 例如：[belongCard]为老红龙：血变成15，那么此时可以返回两个[club.xiaojiawei.hsscriptcardsdk.bean.Action]，一个[club.xiaojiawei.hsscriptcardsdk.bean.Action]作用于敌方英雄，一个[club.xiaojiawei.hsscriptcardsdk.bean.Action]作用于己方英雄
     * @param war 此卡牌所处的战局，注意：生成的[club.xiaojiawei.hsscriptcardsdk.bean.Action]中应使用[club.xiaojiawei.hsscriptcardsdk.bean.Action]内部传递的war，而不是此处的war
     * @param player 此卡牌所处的玩家
     */
...
//                添加至原卡牌位置的右侧
    ...
    /**
     * 发射星舰
     * 执行前判断[club.xiaojiawei.hsscriptcardsdk.bean.BaseCard.isLaunchpad]
     * @return 为null表示执行失败
     */
    ...
    /**
     * 交易
     * 执行前判断[club.xiaojiawei.hsscriptcardsdk.bean.BaseCard.isTradeable]
     * @return 为null表示执行失败
     */
