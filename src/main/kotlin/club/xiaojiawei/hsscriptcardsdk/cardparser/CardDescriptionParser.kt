...
//        println(tokenize)
    ...
    fun parse(dbCard: DBCard): List<CardActionEnum> {
                    ...
                    val playCardAction: CardActionEnum? = if ((value == null)) {
                            ...
                            is Damage -> {
                                when (camp) {
                                    is Enemy -> when (target) {
                                        ...
                                        is Hero -> CardActionEnum.POINT_RIVAL_HERO
                                    ...
                                    is Friendly -> when (target) {
                                        ...
                                        is Hero -> CardActionEnum.POINT_MY_HERO
                        ...
                        when (camp) {
                            ...
                            is Friendly -> when (target) {
                                ...
                                is Hero -> if (value.number > 0) CardActionEnum.POINT_MY_HERO else CardActionEnum.POINT_RIVAL_HERO
